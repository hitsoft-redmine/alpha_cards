class Alphacards < ActiveRecord::Base
  ...
  def generatecards
    ...
    Alpacards.create(:cardtype => "Stakeholders",
                     :position => 1,
    ...
    Alphacards.create(:cardtype => "Software System",
                      :position => 1,
                      :data => '{"title":"Demonstrable","steps":{"Key architectural characteristics demonstrated":0,"System exercised & performance measured":0, "Critical HW conﬁgurations demonstrated":0, "Critical interfaces demonstrated":0, "Integration with environment demonstrated":0, "Architecture accepted as fit-for-purpose":0},"number":2,"total":6}',
                      :projectid => params[:pid])
    Alphacards.create(:cardtype => "Software System",
                      :position => 1,
